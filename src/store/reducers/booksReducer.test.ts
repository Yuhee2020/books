...
test('book should be changed, when getBook is pending', () => {
  const book = {
    ...
    volumeInfo: {
      ...
      imageLinks: {
        smallThumbnail:
          'http://books.google.com/books/content?id=h5TKRgbsYUQC&printsec=frontcover&img=1&zoom=5&edge=curl&imgtk=AFLRE72_mmPe5tLqE_pI2fjB4P5UVwOGnZcTVxPWccRfL92CMLTqCNQL8bFIyWhBdSwgj0PSlUs5t2z6LdQmAmRF_W_xZYUiFq2u5tof4lNWRvIWlxRxoTCEtGNqP1D-pOkiQMgPE7F6&source=gbs_api',
        thumbnail:
          'http://books.google.com/books/content?id=h5TKRgbsYUQC&printsec=frontcover&img=1&zoom=1&edge=curl&imgtk=AFLRE73RxbxBQNEiERk4CZ1CfI9lUzzQjqlE-Mc0ov5JfZq4E7qc1TC8nIySeKSrvkKgi4_FKnKiego8PAy3muO4ZfNCmQeGWpXKak6CfyRWmdIZdUK_114nWyiZHrgdbYnSxYit-e-w&source=gbs_api',
        small:
          'http://books.google.com/books/content?id=h5TKRgbsYUQC&printsec=frontcover&img=1&zoom=2&edge=curl&imgtk=AFLRE722gDA9F7t_IFExKDK1Izfh4NhRCsdzzZoSY-EytUbCVK7f-vn_vA4wfNwOPQ45eaRLHN1oFziri9jncltVtgV_H04C-XE02CoP3CT2rGReB0Q11UK2OItZ0j_c9uQ6G9RaX-IX&source=gbs_api',
        medium:
          'http://books.google.com/books/content?id=h5TKRgbsYUQC&printsec=frontcover&img=1&zoom=3&edge=curl&imgtk=AFLRE72i1Cs0NiOGcpdeZh1Jyoap7A-lfomRR0iGmpha3MHqa2WDQFg_jQUpp_sDvqxV7cnKJ99rjAbOw4LdFJ9AG03RsgpgbrczBm4KVCx8iKZ7zr0QVi4uB_REfylCZEHnlnPopZBx&source=gbs_api',
        large:
          'http://books.google.com/books/content?id=h5TKRgbsYUQC&printsec=frontcover&img=1&zoom=4&edge=curl&imgtk=AFLRE722vu6HO3iC6MbspTERVdrPlcDvuCbgmCv8hQzoD1LoKF8QcRGecXTIut4geGTIT2v3T7w_nEE2uKyH9N3alYZnOXOihlpvU6LTFZaEPDbRCzHf-iS2Yj9W4Kwp2WVDy07gsH7l&source=gbs_api',
        extraLarge:
          'http://books.google.com/books/content?id=h5TKRgbsYUQC&printsec=frontcover&img=1&zoom=6&edge=curl&imgtk=AFLRE70QQDS_IWdf5atwH9O_XX4I3zAnC-kN1KRway46uUSLUmeRodyt-OxO1omCpagck20IyuQVORDTRgkkIU49vKHMEp0cdU9qIfZKfvBgG6PAclHWBBKbqGwJaAX1bHAxvUc2C2y7&source=gbs_api',
      },
      language: 'en',
      previewLink: 'http://books.google.pl/books?id=h5TKRgbsYUQC&hl=&source=gbs_api',
      infoLink:
        'https://play.google.com/store/books/details?id=h5TKRgbsYUQC&source=gbs_api',
    ...
    accessInfo: {
      ...
      pdf: {
        isAvailable: true,
        acsTokenLink:
          'http://books.google.pl/books/download/Complete_string_quintets_with_the_horn_a-sample-pdf.acsm?id=h5TKRgbsYUQC&format=pdf&output=acs4_fulfillment_token&dl_type=sample&source=gbs_api',
      },
      webReaderLink:
        'http://play.google.com/books/reader?id=h5TKRgbsYUQC&hl=&source=gbs_api',
